...
#### Утечки в интерфейсах

Если вы объявили `interface`, имеющий множество методов, это указывает на утечку абстракции. Подумайте, как можно определить это взаимодействие с помощью более узкого набора методов, в идеале - одного.
